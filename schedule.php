  ...
  <body>
		<header class="clearfix">
			...
			<nav class="clearfix">
				<ul class="clearfix">
					...
					<li><a href="scedule.php" class="active">กำหนดการ</a></li>
		...
		<div class="container" style="margin-top:2%;">
			<div class="row">
				<div class="col-xs-12 col-md-6">
					<table class="table table-condensed">
							<tr class="info">
									<th scope="row">วันที่ 2 กุมภาพันธ์ พ.ศ. 2558</th>
									 <td></td>
										<td colspan="2"> ตึกปฏิบัติการวิศวกรรม 2 (ECC)</td>
							...
							<tr>
							 ...
							 <tr class="warning">
									...
									<td colspan="3"> พักรับประทานอาหารกลางวัน</td>
							</tr>
							<tr>
			...
			<div class="col-xs-12 col-md-6">
					<table class="table table-condensed">
							<tr class="info">
									<th scope="row">วันที่ 3 กุมภาพันธ์ พ.ศ. 2558</th>
									 <td></td>
									<td colspan="2"> ตึกปฏิบัติการวิศวกรรม 2 (ECC)</td>
							</tr>
							<tr class="danger">
