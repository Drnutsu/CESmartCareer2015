  ...
  <body>
		<header class="clearfix">
			...
			<nav class="clearfix">
				<ul class="clearfix">
					...
					<li><a href="plan.php" class="active">แผนผัง</a></li>
		...
		<div class="banner" style="overflow: hidden; width: 100%; height: 340px;">
			<ul style="width: 200%; position: relative; height: 360px;margin-top:-50px;">
				<li class="slideshow" style="width: 50%;">
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-md-offset-3">
								<div class="hero-title">แผนผังอยู่ในขั้นจัดทำ</div>
								<p class="hero-content">ขออภัยในความไม่สะดวก</p>
							</div>
						</div>
					</div>
				</li>
